...
Rectangle {
    ...
    ColumnLayout {
        ...
        ComboBox {
            id: sessionMenu
            Layout.alignment: Qt.AlignHCenter
            // Width perfectly aligns with the row of 3 buttons below (48 + 24 + 48 + 24 + 48 = 192)
            ...
            background: Rectangle {
                ...
                radius: 24 // Matches the fully rounded style of the power buttons
                border.width: 1
            ...
            popup: Popup {
                y: -(sessionMenu.popup.height + 8) // Opens upwards cleanly
