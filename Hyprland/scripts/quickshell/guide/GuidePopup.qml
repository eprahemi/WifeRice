            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    ListView {
                        ...
                        model: ListModel {
                            ListElement { version: "v1.7.48"; title: "Auto-Detect Monitor Name on Fresh Install"; desc: "settings.json now uses real monitor name from sysfs instead of hardcoded eDP-1"; icon: "󰒃"; clr: "blue"; detail: "ADDED: Auto-detect monitor name on fresh install — reads first connected display from sysfs, injects real name into settings.json instead of hardcoded eDP-1. Falls back to default if detection fails or jq is missing. Final validation checks JSON is valid before deploying." }
